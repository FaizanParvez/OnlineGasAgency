...
<div id="apDiv1">
  <form name="form1" method="post" action="seventeenus.asp">
    <table width="602" height="470" border="0">
      <tr>
        <td width="154"><label for="fname">First Name :</label></td>
      ...
      <tr>
        ...
        <td><span id="spryselect1">
          <select name="gender" id="gender">
            <option selected>Unbound</option>
            <option>Male</option>
...
<div id="apDiv2">
  <h2><em>Consumer Registration Form :</em></h2>
</div>
