...
<h3 align="justify">
  You can  check the  availablity of stock in the request  menu. If  any distributor is running low on stock you can provide him the stock.
  You can  also see  the comments in   the Reports menu which were posted by  distributors.
    <pre><h4> 
